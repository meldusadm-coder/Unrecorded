...
void main() {
  test('scan and alert copy avoids certainty wording', () {
    final copyStrings = <String>[
      ...
      AppCopy.possibleRiskNotificationTitle,
      AppCopy.possibleRiskNotificationBody,
      ...
      AppCopy.protectionStatusNotificationRecentRiskBody,
      ...
      AppCopy.backgroundProtectionNotificationTitle,
      AppCopy.backgroundProtectionNotificationDefaultBody,
      AppCopy.backgroundProtectionStopAction,
      AppCopy.backgroundProtectionNotificationRequired,
      AppCopy.backgroundProtectionStoppedByAndroid,
      AppCopy.backgroundProtectionRestart,
